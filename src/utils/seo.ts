export const BASE_URL = "https://hm-global-gateway-consultancy.vercel.app"

export const DEFAULT_OG_IMAGE = `${BASE_URL}/hm-global-logo.png`

export const SITE_NAME = "HM Global Gateway Consultancy"
...
export const PAGE_SEO: Record<string, SEOMeta> = {
  home: {
    title: "HM Global Gateway | #1 Study Abroad Consultancy in Pakistan",
    description:
      "HM Global Gateway Consultancy — Pakistan's trusted study abroad experts. Get expert admission guidance, scholarships, and visa assistance for South Korea, Germany, UK, Italy, and Cyprus.",
    canonical: `${BASE_URL}/`,
    ogType: "website",
    keywords:
      "study abroad consultancy Pakistan, study abroad consultant Pakistan, student visa Pakistan, study in South Korea from Pakistan, study in Germany from Pakistan, study in UK from Pakistan, HM Global Gateway",
  },
  countries: {
    title: "Study Abroad Destinations | South Korea, Germany, UK, Italy, Cyprus | HM Global Gateway",
    description:
  ...
  services: {
    title: "Study Abroad Services in Pakistan | Admissions, Visa & Scholarships | HM Global Gateway",
    description:
  ...
  scholarships: {
    title: "Scholarships for Pakistani Students Abroad | GKS, DAAD, Chevening | HM Global Gateway",
    description:
  ...
  visa: {
    title: "Student Visa Assistance Pakistan | 95% Success Rate | HM Global Gateway",
    description:
  ...
  universities: {
    title: "Partner Universities Abroad | 50+ Universities | HM Global Gateway Pakistan",
    description:
  ...
  about: {
    title: "About HM Global Gateway | Study Abroad Consultancy in Narowal, Punjab, Pakistan",
    description:
      "HM Global Gateway Consultancy — founded in Narowal, Punjab. 95%+ visa success rate, 500+ students placed in South Korea, Germany, UK, Italy, and Cyprus. Meet our expert team.",
    canonical: `${BASE_URL}/about`,
    keywords:
      "HM Global Gateway Consultancy, study abroad consultancy Narowal, study abroad consultancy Punjab Pakistan",
  },
  contact: {
    title: "Book Free Consultation | Contact HM Global Gateway Consultancy Pakistan",
    description:
      "Contact HM Global Gateway Consultancy for a free study abroad consultation. Call, WhatsApp, or email us. Office in Narowal, Punjab, Pakistan. We respond within 24 hours.",
    canonical: `${BASE_URL}/contact`,
    keywords: "study abroad consultation Pakistan, free consultation study abroad, contact HM Global Gateway",
  },
  faq: {
    title: "Study Abroad FAQs | HM Global Gateway Consultancy Pakistan",
    description:
  ...
  testimonials: {
    title: "Student Success Stories | Pakistani Students Studying Abroad | HM Global Gateway",
    description:
      "Read real success stories from Pakistani students who studied in South Korea, Germany, UK, Italy, and Cyprus with HM Global Gateway Consultancy. 95% visa success rate.",
    canonical: `${BASE_URL}/testimonials`,
    keywords:
      "study abroad success stories Pakistan, HM Global Gateway reviews, Pakistani students abroad testimonials",
  },
}
...
export const COUNTRY_SEO: Record<string, SEOMeta> = {
  "south-korea": {
    title: "Study in South Korea from Pakistan | GKS Scholarship & D-2 Visa | HM Global Gateway",
    description:
  ...
  germany: {
    title: "Study in Germany from Pakistan | Free Education & DAAD Scholarship | HM Global Gateway",
    description:
  ...
  uk: {
    title: "Study in UK from Pakistan | Chevening Scholarship & Student Visa | HM Global Gateway",
    description:
  ...
  italy: {
    title: "Study in Italy from Pakistan | Affordable Education & DSU Scholarship | HM Global Gateway",
    description:
  ...
  cyprus: {
    title: "Study in Cyprus from Pakistan | EU Degree & English Programs | HM Global Gateway",
    description:
  ...
  austria: {
    title: "Study in Austria from Pakistan | OeAD Scholarship | HM Global Gateway",
    description:
