...
const SITE_URL = "https://mh-global-gateway-consultancy.vercel.app"
const SITE_NAME = "MH Gateway Consultancy"
const DEFAULT_IMAGE = `${SITE_URL}/mh-gateway-logo.png`
...
const pageMetadata: Record<string, PageMetadata> = {
  "/": {
    title: "Study Abroad Consultancy in Pakistan | MH Gateway Consultancy",
    description: "MH Gateway Consultancy helps students from Pakistan apply to universities in South Korea, Germany, the UK, Italy, Cyprus and Austria with admissions, scholarships and visa guidance.",
    keywords: `${baseKeywords}, international education consultant, overseas education consultant`,
  },
  "/countries": {
    title: "Study Abroad Destinations for Pakistani Students | MH Gateway Consultancy",
  ...
  "/services": {
    title: "Study Abroad and Student Visa Services in Pakistan | MH Gateway Consultancy",
  ...
  "/scholarships": {
    title: "Study Abroad Scholarships for Pakistani Students | MH Gateway Consultancy",
  ...
  "/visa": {
    title: "Student Visa Assistance in Pakistan | MH Gateway Consultancy",
  ...
  "/universities": {
    title: "Partner Universities for Pakistani Students | MH Gateway Consultancy",
    description: "Browse universities and programs available to Pakistani students through MH Gateway Consultancy, with guidance for applications and admissions.",
    keywords: `${baseKeywords}, universities abroad for Pakistani students, international university admissions`,
  },
  "/about": {
    title: "About MH Gateway Consultancy | Pakistan",
    description: "Learn how MH Gateway Consultancy supports Pakistani students with transparent guidance for international university admissions and student visas.",
    keywords: `${baseKeywords}, MH Gateway Consultancy, education consultants in Pakistan`,
  },
  "/contact": {
    title: "Contact a Study Abroad Consultant in Pakistan | MH Gateway Consultancy",
    description: "Contact MH Gateway Consultancy in Narowal, Punjab, Pakistan for study abroad admissions, scholarships and student visa guidance.",
    keywords: `${baseKeywords}, contact study abroad consultant, education consultant Narowal`,
  },
  "/faq": {
    title: "Study Abroad and Student Visa FAQs | MH Gateway Consultancy",
  ...
  "/testimonials": {
    title: "Student Success Stories | MH Gateway Consultancy",
    description: "Read student experiences with MH Gateway Consultancy for university admissions, scholarships and student visa applications abroad.",
    keywords: `${baseKeywords}, study abroad success stories, student visa reviews Pakistan`,
  },
  "/admin": {
    title: "Admin | MH Gateway Consultancy",
    description: "Administrative dashboard for MH Gateway Consultancy.",
    keywords: "",
    noindex: true,
  },
}
...
function getCountryMetadata(pathname: string): PageMetadata | undefined {
  ...
  if (!country) {
    return {
      title: "Country Not Found | MH Gateway Consultancy",
  ...
  return {
    title: `Study in ${country.name} from Pakistan | MH Gateway Consultancy`,
  ...
  useEffect(() => {
    ...
    const organization: JsonLd = {
      ...
      contactPoint: {
        ...
        email: "info@MHglobalgateway.com",
        ...
        itemListElement: [
          ...
          ...(pathname.startsWith("/countries/")
            ? [
                ...
                { "@type": "ListItem", position: 3, name: metadata.title.replace(" | MH Gateway Consultancy", ""), item: canonicalUrl },
              ]
            : pathname !== "/"
              ? [{ "@type": "ListItem", position: 2, name: metadata.title.replace(" | MH Gateway Consultancy", ""), item: canonicalUrl }]
              : []),
        ],
      })
    }
